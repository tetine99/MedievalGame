...
MedievalGame.Lives = function (game_state, position, properties) {
    "use strict";
...
MedievalGame.Lives.prototype = Object.create(MedievalGame.Prefab.prototype);
MedievalGame.Lives.prototype.constructor = MedievalGame.Lives;

MedievalGame.Lives.prototype.update = function () {
    "use strict";
...
MedievalGame.Lives.prototype.create_lives = function () {
    var life_index, life_position, life;
    // create a sprite for each ine of the player lives
...
MedievalGame.Lives.prototype.update_lives = function () {
    "use strict";
